...
*/
    ...
    private void uploade1(String buttonKey) {
      ...
      //  Button  choosefile = (Button)dialog_layout.findViewById(R.id.choosefile);
        ...
        uploadsubmit.setOnClickListener(onAddingListener1(friendArrayList1,buttonKey));
    ...
    private View.OnClickListener onAddingListener1(final ArrayList friendArrayList1, final String buttonKey) {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                uploadsubmit.setOnClickListener(onConfirmListener1(add, friendArrayList1, buttonKey));
                Displaydata.setText("");
    ...
    private View.OnClickListener onConfirmListener1(final String Name, final ArrayList friendArrayList1, String buttonKey) {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
