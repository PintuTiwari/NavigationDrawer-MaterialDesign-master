...
*/
    ...
    private void uploade() {
           ...
           recyclerView.setLayoutManager(layoutManager);
            ...
            Log.d("uploadsubmit", "uploadsubmit");
...
*/
    ...
    private View.OnClickListener onAddingListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("onConfirmListener", "onConfirmListener");
                Displaydata.setText("");
            }
        };
    }
    ...
    private View.OnClickListener onConfirmListener(final String Name) {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("friendArrayList11", "friendArrayList11");
...
*/
    ...
    private void getImageFromGallery() {
     ...
     /*   Intent intent1 = new Intent();
        ...
        startActivityForResult(Intent.createChooser(intent1, "Complete action using"), SELECT_PICTURE2);*/
    }
    @Override
