            ...
            if (responnsedisplay.length() > 0) {
                ...
                //    Log.d("SubSec:: ", SubSec.toString());
                  //  Log.d("SsecDesc:: ", SsecDesc.toString());
                    ...
                    if(SubSec.contains("RENTPAID")){houserentpaids = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD14")){LICpremiumpaids = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD15")){Publicprovidentfunds = jsonObject.getString("Amount");}
                    if( SubSec.contains("SUBFLD16")){Approvedannuationfunds = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD17")){Anysumpaidhousingdocuments = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD18")){PFdeductedpreviousemployers = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD19")){NSCs = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD20")){ULIPs = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD21")){Contributionpensionfunds = jsonObject.getString("Amount");}
                    if( SubSec.contains("SUBFLD22")){ContributionELSS = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD23")){Tutionfeespaids = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD25")){Medicalinsurancepremiums = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD26")){Repaymentloaneducations = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD27")){DonationscertainfundsAggregates = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD29")){Repaymenthousingloans = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD30")){Entertainmentallowances = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD32")){Investmentmutualfunds = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD34")){Otherss = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD35")){SelfSpouseKidss = jsonObject.getString("Amount");}
                    if(SubSec.contains("SUBFLD36")){MediclaimParentss = jsonObject.getString("Amount");}
                    if(SubSec.contains("OTHINC1")){IncomeHousingPropertys = jsonObject.getString("Amount");}
                    if(SubSec.contains("OTHINC2")){InterestHousingPropertys = jsonObject.getString("Amount");}
                    if(SubSec.contains("OTHINC3")){InterestHousingPropertyResidentials = jsonObject.getString("Amount");}
                    if(SubSec.contains("OTHINC4")){IncomefromSourcess = jsonObject.getString("Amount");}
                    if(SubSec.contains("OTHINC6")){CapitalGainss = jsonObject.getString("Amount");}
                    if(SubSec.contains("Medical_Bill")){TotalAmountMedicalBillClaimeds = jsonObject.getString("Amount");}
                    if(SubSec.contains("NoOfChildren")){NochildrenEligibleEducations = jsonObject.getString("Amount");}
                    if(SubSec.contains("PrimeMin_Fund")){PrimeMinistersReliefFunds = jsonObject.getString("Amount");}
                    if(SubSec.contains("ChiefMin_Fund")){ChiefMinistersReliefFunds = jsonObject.getString("Amount");}
