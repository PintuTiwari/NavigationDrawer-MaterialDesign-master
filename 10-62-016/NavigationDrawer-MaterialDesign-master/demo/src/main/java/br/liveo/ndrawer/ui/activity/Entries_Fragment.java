...
public class Entries_Fragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TextView DEntertainmentallowance, DLICpremiumpaid, DPublicprovidentfund, DApprovedannuationfund,
                    DAnysumpaidhousingdocument, DPFdeductedpreviousemployer , DNSC, DULIP, DContributionpensionfund,
                    DContributionELS, DTutionfeespaid, DRepaymenthousingloan, DInvestmentmutualfund, DOthers,
                    DMedicalinsurancepremium, DRepaymentloaneducation, DDonationscertainfundsAggregate, DSelfSpouseKids,
                    DMediclaimParents, DIncomeHousingProperty, DIncomefromSources, DCapitalGains,
                    DInterestHousingProperty, DInterestHousingPropertyResidential, DTotalAmountMedicalBillClaimed,
                   DNochildrenEligibleEducation, DPrimeMinistersReliefFund, DChiefMinistersReliefFund;
...
*/
            ...
            if(position==2) {
             ...
             //   houserelative.getId().toString();
               // Log.d("HI",houserelative.toString());
    ...
    private void uploade() {
        ...
        EditText  Training_Name = (EditText)dialog_layout.findViewById(R.id.februarynonmetro);
        Button  choosefile = (Button)dialog_layout.findViewById(R.id.choosefile);
        Training_Name.setText("House Rent Paid");
        Training_Name.setEnabled(false);
